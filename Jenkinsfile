pipeline {
    ...
    stages {
        ...
        stage('Deploy to Docker Host') {
          steps {
            sh    'docker -H tcp://10.0.13.37:2375 stop masterwebapp1 || true'
            sh    'docker -H tcp://10.0.13.37:2375 run --rm -dit --name masterwebapp1 --hostname masterwebapp1 -p 8000:80 muralinikkala/pipelinetestmaster:${BUILD_NUMBER}'
            }
        }
